...
Here we provide code implementing CTR for predicting the change in protein folding free energy upon single-point amino acid mutation.

The FireProt dataset is stored at ./data/fireprot.csv.
